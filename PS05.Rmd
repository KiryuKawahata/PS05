...
We are picking a model which uses Windspeed, temperature, and Humidity as the three predictors to predict Count with. In the correlation plot above, these 3 variables had the strongest apparent relationship to "count". Windspeed was used instead of adjusted temperature to avoid obvious covariance between temp and atemp.
